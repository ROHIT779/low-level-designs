...
public class Client {
    ...
    public static void main(String[] args){
        ...
        System.out.println("Message content after using HtmlEncoder(Decorator): " + decorator.getContent());
        ...
        System.out.println("Message content after using Base64Encoder(Decorator): " + decorator.getContent());
    }
}
